...
from .discrete import GridShortestPath
from .discrete import GraphColoring
from .discrete import Knapsack
from .discrete import TravelingSalesman
from .discrete import EuclideanShortestPath

__all__ = ['EuclideanShortestPath', 'GraphColoring', 'Ackley', 'Griewank', 'Knapsack', 'Rastrigin', 'Rosenbrock', 'ShortestPath', 'Sphere', 'TravelingSalesman', 'GridShortestPath']